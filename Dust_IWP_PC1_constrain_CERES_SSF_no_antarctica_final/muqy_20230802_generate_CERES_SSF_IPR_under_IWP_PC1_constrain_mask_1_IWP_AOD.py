# -*- coding: utf-8 -*-
# @Author: Muqy
# @Date:   2023-09-13 11:21:35
# @Last Modified by:   Muqy
# @Last Modified time: 2023-11-20 14:53:12
#                  ___====-_  _-====___
#            _--^^^#####//      \\#####^^^--_
#         _-^##########// (    ) \\##########^-_
#        -############//  |\^^/|  \\############-
...
def generate_filtered_data_for_all_years(
    ...
    """
    # Set up the gap for IWP, PC
    IWP_gap = IWP_gaps

    PC_gap = PC_gaps

    # Set up the filter class
...
def save_filtered_data_as_nc(
    ...
    Cld_match_PC_gap_IWP_AOD_constrain_mean.to_netcdf(
        save_path
        + "_match_PC_gap_IWP_constrain_mean_2005_2020_"
        + "mask_1_IWP_no_antarc_new_PC_IWP_gaps_no_AOD_constraint.nc"
    )
...
save_filtered_data_as_nc(
    ...
    IWP_gap,
    PC_gap,
    save_path="/RAID01/data/Filtered_data/CERES_SSF_COD",
)
