...
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_HCF = read_filtered_data_out(
    file_name="CERES_SSF_HCF_match_PC_gap_IWP_constrain_mean_2005_2020_mask_1_IWP_no_antarc_new_PC_IWP_gaps_no_AOD_constraint.nc"
)
# Read the Dust constrain cld icerad data
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR = read_filtered_data_out(
    file_name="CERES_SSF_IPR_match_PC_gap_IWP_constrain_mean_2005_2020_mask_1_IWP_no_antarc_new_PC_IWP_gaps_no_AOD_constraint.nc"
)
# Read the Dust constrain cld top pressure data
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_CTP = read_filtered_data_out(
    file_name="CERES_SSF_CTP_match_PC_gap_IWP_constrain_mean_2005_2020_mask_1_IWP_no_antarc_new_PC_IWP_gaps_no_AOD_constraint.nc"
)
# Read the Dust constrain cld optical depth data
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_COD = read_filtered_data_out(
    file_name="CERES_SSF_COD_match_PC_gap_IWP_constrain_mean_2005_2020_mask_1_IWP_no_antarc_new_PC_IWP_gaps_no_AOD_constraint.nc"
)
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_CEP = read_filtered_data_out(
    file_name="CERES_SSF_CEP_match_PC_gap_IWP_constrain_mean_2005_2020_mask_1_IWP_no_antarc_new_PC_IWP_gaps_no_AOD_constraint.nc"
)

# Extract AOD bin, PC1 bin, IWP bin values
AOD_gaps_values = (
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_HCF.AOD_bin.values
)
PC1_gaps_values = (
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_HCF.PC_bin.values
)
IWP_gaps_values = (
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_HCF.IWP_bin.values
)
...
def plot_both_3d_fill_plot_min_max_version(
    ...
    high_cloud_amount_diff = np.diff(high_cloud_amount_mean, axis=0)
...
# high cloud area
plot_both_3d_fill_plot_min_max_version(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_HCF,
    "Dust-AOD",
    "PC1",
...
plot_both_3d_fill_plot_min_max_version(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR,
    "Dust-AOD",
    "PC1",
    "IWP (g/m" + r"$^2$" + ")",  # IWP (g/m^2)
...
# cloud top pressure
plot_both_3d_fill_plot_min_max_version(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_CTP,
    "Dust-AOD",
    "PC1",
    "IWP (g/m" + r"$^2$" + ")",  # IWP (g/m^2)
...
plot_both_3d_fill_plot_min_max_version(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_CEP,
    "Dust-AOD",
    "PC1",
    "IWP (g/m" + r"$^2$" + ")",  # IWP (g/m^2)
...
# cloud optical depth
plot_both_3d_fill_plot_min_max_version(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_COD,
    "Dust-AOD",
    "PC1",
    "IWP (g/m" + r"$^2$" + ")",  # IWP (g/m^2)
...
# Low IWP region
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_Dust_IPR_masked_low_IWP = CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR.where(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR[
        "IWP_bin"
    ]
    <= 1,
...
# Mid-Low IWP region
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_Dust_IPR_masked_mid_low_IWP = CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR.where(
    (
        CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR[
            "IWP_bin"
        ]
...
# Mid-High IWP region
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_Dust_IPR_masked_mid_high_IWP = CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR.where(
    (
        CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR[
            "IWP_bin"
        ]
...
# High IWP region
CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_Dust_IPR_masked_high_IWP = CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR.where(
    CERES_SSF_match_PC_gap_IWP_AOD_constrain_mean_IPR[
        "IWP_bin"
    ]
    >= 50,
...
def plot_spatial_distribution(
    ...
    """
    Plots a spatial distribution of data on a Plate Carree projection map.
    ...
    AOD_intervals : list
        A list of intervals to define the color boundaries of the plot.
    cmap : str, optional
        The name of the colormap to be used for the plot. Default is "jet".
...
def plot_spatial_distribution_with_contour(
    data, var_name, title, AOD_intervals, cmap="jet"
):
    """
    Plots a spatial distribution of data on a Plate Carree projection map.
...
# Mid-High IWP scenario
plot_spatial_distribution_mask_contour(
    data=IWP_data,
    var_name="IWP Frequency",
    title="Spatial Distribution of IWP Frequency Section",
    data_intervals=IWP_gaps_values,
    mask_threshold=[14, 22],
    cmap="RdYlBu_r",
)
...
CERES_SSF_match_PC_gap_IWP_constrain_mean_IPR = read_filtered_data_out(
    file_name="CERES_SSF_IPR_match_PC_gap_IWP_AOD_constrain_mean_2005_2020_Dust_AOD_mask_1_IWP_AOD_no_antarc_new_PC_IWP_gaps_4_AOD_gaps_for_FIE_ME.nc"
)
...
AOD_match_PC_gap_IWP_constrain_mean = read_filtered_data_out(
    file_name="AOD_match_PC_gap_IWP_AOD_constrain_mean_2005_2020_Dust_AOD_mask_1_IWP_AOD_no_antarc.nc"
)
...
PC1_match_PC_gap_IWP_constrain_mean = read_filtered_data_out(
    file_name="PC1_match_PC_gap_IWP_AOD_constrain_mean_2005_2020_Dust_AOD_mask_1_IWP_AOD_no_antarc.nc"
)
        ...
        for idx, IWP_region in enumerate(IWP_regions):
            ...
            for i in range(cld_data_region.shape[2]):
                ...
                if (
                    ...
                    p_values[AOD_bin, idx, i] = p_values_region_bin
...
FIE_da, FIE_p_values_da, FIE_std_errs_da = FIE_calculator(
    IWP_regions=[
        (
            CERES_SSF_match_PC_gap_IWP_constrain_mean_IPR["IWP_bin"]
            <= 2.2
        ),
        (
            (
...
def plot_FIE_diverse_AOD(
    ...
    for IWP_idx, ax in enumerate(axs.flat):
        ...
        ax.plot(
            zero_line, np.zeros_like(zero_line), "k", linewidth=4.5
        )
