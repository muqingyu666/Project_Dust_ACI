...
def generate_filtered_data_for_all_years(
    ...
    print("Calculated IWP, PC, and AOD gaps are:" + str(IWP_gap) + str(PC_gap) + str(AOD_gap))
    ...
    (
        ...
        AOD_match_PC_gap_IWP_AOD_constrain_mean,
...
def save_filtered_data_as_nc(
    ...
    if save_AOD:
        AOD_match_PC_gap_IWP_AOD_constrain_mean = xr.DataArray(
            AOD_match_PC_gap_IWP_AOD_constrain_mean,
            dims=["AOD_bin", "IWP_bin", "PC_bin", "lat", "lon"],
            coords={
                "AOD_bin": AOD_gap[1:],
        ...
        AOD_match_PC_gap_IWP_AOD_constrain_mean.to_netcdf(
            "/RAID01/data/Filtered_data/AOD_match_PC_gap_IWP_AOD_constrain_mean_2010_2020_"
            + AOD_name
            + "_mask_1_IWP_AOD_no_antarc.nc"
        )
    if save_PC1:
        ...
        PC1_match_PC_gap_IWP_AOD_constrain_mean.to_netcdf(
            "/RAID01/data/Filtered_data/PC1_match_PC_gap_IWP_AOD_constrain_mean_2010_2020_"
            + AOD_name
            + "_mask_1_IWP_AOD_no_antarc.nc"
        )
...
(
    ...
    AOD_match_PC_gap_IWP_AOD_constrain_mean_Dust,
...
PC1_match_PC_gap_IWP_AOD_constrain_mean_Dust = None
